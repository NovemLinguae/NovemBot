...
class FGTCSteps {
	...
	private function addToUserspaceLog() {
		...
		// add one second, to fix #85 Task1Log "diff" link is off by one
		$mostRecentRevisionTimestamp++;
	...
	private function makeTopicPage() {
		...
		// This is our first edit. Everything before here is read only (except for clearing unread pings)
		$this->wapi->edit( $this->topicWikipediaPageTitle, $topicWikipediaPageWikicode, $this->topicWikipediaPageTitle, $this->goodOrFeatured );
	}

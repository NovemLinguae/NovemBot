...
class HelperTest extends TestCase {
	...
	public function test_insertCodeAtEndOfFirstTemplate_TemplateWithParameters() {
...
[inserted code]
	...
	public function test_insertCodeAtEndOfFirstTemplate_CaseInsensitiveIsWorking() {
		$templateNameRegEx = 'Article ?history';
		$codeToInsert = '[inserted code]';
		$wikicode = '{{article history|test}}';
		$result = $this->h->insertCodeAtEndOfFirstTemplate( $wikicode, $templateNameRegEx, $codeToInsert );
...
[inserted code]
	...
	public function test_insertCodeAtEndOfFirstTemplate_RegExIsWorking() {
		$templateNameRegEx = 'Article ?history';
		$codeToInsert = '[inserted code]';
...
[inserted code]
	...
	public function test_insertCodeAtEndOfFirstTemplate_TemplateWithNestedTemplate() {
		$templateNameRegEx = 'Article ?history';
		$codeToInsert = '[inserted code]';
...
[inserted code]
	...
	public function test_insertCodeAtEndOfFirstTemplate_TemplateWithNoParameters() {
		$templateNameRegEx = 'Article ?history';
		$codeToInsert = '[inserted code]';
...
[inserted code]
	...
	public function test_insertCodeAtEndOfFirstTemplate_TwoTemplatesWithSameName() {
		$templateNameRegEx = 'Article ?history';
		$codeToInsert = '[inserted code]';
		$wikicode =
'test
...
test', $result );
	...
	public function test_preg_position_false() {
		$regex = '/hello/si';
	...
	public function test_preg_position_zero() {
		$regex = '/How/si';
		$haystack = 'How are you?';
		$result = $this->h->preg_position( $regex, $haystack );
	...
	public function test_preg_position_positive() {
		$regex = '/are/si';
		$haystack = 'How are you?';
		$result = $this->h->preg_position( $regex, $haystack );
	...
	public function test_preg_position_end() {
		$regex = '/$/si';
		$haystack = 'How are you?';
		$result = $this->h->preg_position( $regex, $haystack );
	...
	public function test_deleteArrayValue_deleteOneValue() {
	...
	public function test_deleteArrayValue_okIfValueNotFound() {
		$array = [ 'test1', 'test2', 'test3' ];
		$valueToDelete = 'test4';
		$result = $this->h->deleteArrayValue( $array, $valueToDelete );
	...
	public function test_deleteArrayValue_firstParameterNotArray() {
		$array = 'test1';
		$valueToDelete = 'test4';
	...
	public function test_deleteMiddleOfString() {
	...
	public function test_deleteMiddleOfString_blank() {
		$string = '';
	...
	public function test_deleteArrayValuesBeginningWith_normal() {
		$array = [
			1 => 'a',
			2 => 'b',
			3 => 'c',
	...
	public function test_sliceFirstTemplateFound_normal() {
		$wikicode =
"Test
{{Good topic box
| algo                = old(120d)
...
| minthreadsleft      = 4
	...
	public function test_sliceFirstTemplateFound_secondTemplate() {
		$wikicode =
"Test
{{tmbox
|text= '''Questions about a topic you are working on or about the process in general should be asked at [[Wikipedia talk:Featured and good topic questions|Featured and good topic questions]].'''  This page is primarily for discussion on proposals regarding the FTC process.
...
| minthreadsleft      = 4
	...
	public function test_sliceFirstTemplateFound_templateNotFound() {
		$wikicode =
...
|text= '''Questions about a topic you are working on or about the process in general should be asked at [[Wikipedia talk:Featured and good topic questions|Featured and good topic questions]].'''  This page is primarily for discussion on proposals regarding the FTC process.
	...
	public function test_convertTimestampToOffsetFormat_normal() {
